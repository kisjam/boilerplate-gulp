...
var _scrollAnimation = __webpack_require__(4);
...
window.addEventListener('DOMContentLoaded', function () {
	...
	new _responsiveImage2.default();

	_mobileMenu2.default.init();
	_jquery2.default.smoothScroll();

	var sa = document.querySelectorAll('.sa');
	new _scrollAnimation2.default(sa);
...
var ResponsiveImage = function () {
	function ResponsiveImage() {
		...
		var elems = document.querySelectorAll('[data-sp]');
